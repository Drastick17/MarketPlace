...
import img1 from "../media/mano.jpg";
import img2 from "../media/bolso.webp";
import img3 from "../media/img3.jpg";
import img4 from "../media/correo.webp";
...
const Home = () => {
  return (
    <>
      <section className="w-screen min-h-screen relative top-[168px] left-0 overflow-x-hidden">
        ...
        >
          <p className="text-white text-center">
            ...
            <button className="border-2 border-white my-4 py-5 px-16 transition-colors duration-[0.4s] hover:bg-white hover:text-light-red ">
              Shop the collection
            </button>
          </p>
        </div>
        ...
        <div className="w-screen min-h-screen flex flex-wrap text-center flex-shrink-0">
          <div className="relative w-screen sm:w-1/2 min-h-[400px] max-h-[600px] grid place-content-center text-center text-gray-700 bg-white group">
            <figure>
              <img
                src={img2}
                alt="bolso"
          ...
          <div
            className="relative w-screen sm:w-1/2 min-h-[400px] max-h-[600px] grid place-content-center parallax2"
          ...
          <div
            className="relative w-screen sm:w-1/2 min-h-[400px] max-h-[600px] grid place-content-center background2"
            style={{
          ...
          <div className="relative w-screen sm:w-1/2 min-h-[400px] max-h-[600px] grid place-content-center bg-white group">
            <figure>
              <img
                src={img4}
                alt="correa"
        ...
        <div className="w-screen min-h-screen flex items-center justify-center">
          <div className="w-full grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] auto-rows-[450px] gap-7 sm:gap-14 p-0 sm:p-14 text-center">
            <div
